...
Create Date: 2024-03-08 10:57:20.426722
...
def upgrade():
    ...
    with op.batch_alter_table('review', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_review_user', 'user', ['user_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('review', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('fk_review_user', type_='foreignkey')
