...
class TestReviewService(TestCase):
    ...
    def test_get_all_reviews(self, mock_get_all_reviews):
        ...
        response, status_code = get_all_reviews(
            page, count, tag_id, region_id, category_id
        )
    ...
    def test_create_review(
        ...
        mock_create_review,
        mock_create_tag,
        mock_get_the_hashtag_from_content,
        mock_get_review_id_by_public_id,
        ...
        mock_create_review_tag.assert_called_once_with(
            review_tag_data["tag_id"], review_tag_data["review_id"]
        )
